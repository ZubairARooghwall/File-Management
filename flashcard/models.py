...
class Subject(models.Model):
	...
	picture = models.ImageField(null=True, default="#", blank=True, upload_to="image/avatar",
								max_length=500)  # Add a default image
...
class FlashCard(models.Model):
	creator = models.ForeignKey(User, on_delete=models.SET_NULL, null=True,
								help_text="Who is the original creator of the flashcard. I will add more functionality where learners can 'fork' it like github repo and pull request the mistakes")
	question = models.TextField(max_length=500, null=False, blank=False)
	question_hint = models.CharField(max_length=30, blank=True,
									 help_text="If you forget, it will appear after a certain while")
